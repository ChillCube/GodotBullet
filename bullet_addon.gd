@icon("res://addons/GodotBullet/icon_bullet_blue.png")
extends Sprite2D
class_name Projectile2D

@export var bullet_resource: BulletResource

# Node references — can't live in a Resource
@export_group("Direction")
@export_enum("TARGET_POSITION", "TARGET_NODE", "DIRECTION") var move_using: int = 0
@export_subgroup("Direction")
@export_range(0, 360) var direction: float = 0
...
@export var boomerang_return_target: Node2D = null

# Signals
signal hit_body(body: Node)
signal destroyed(_position: Vector2)
signal boomerang_returned()
signal bounced(hit_node: Node, bounce_count: int, bounce_position: Vector2, new_direction: Vector2, current_speed: float)

# --- Properties (populated from bullet_resource in _ready, or use defaults) ---
var has_collision_shape: bool = true
var collision_shape_size: float = 0.8
var collision_shape_offset: Vector2 = Vector2.ZERO
var collision_mask: int = 1
var collision_layer: int = 1

var bounces_enabled: bool = false
var max_bounces: int = 2
var bounce_damping: float = 0.8
var bounce_angle_variance: float = 0
var bounce_exception_groups: Array[String] = []
var bounce_only_groups: Array[String] = []

var start_speed: float = 100
var relative_falloff: float = 0
var constant_falloff: float = 0

var boomerang: bool = false
var boomerang_trigger: int = 0
var boomerang_start_at_speed: float = 0.5
var boomerang_start_at_distance: float = 100
var boomerang_curve_rate: float = 1.5
var boomerang_curve_direction: int = 0
var dynamic_return_target: bool = false
var max_return_distance: float = 0

var follow_target: bool = true
var steering_degrees: float = 360

var damage: float = 10

var destroy_on_no_speed: bool = true
var destroy_when_colliding: bool = true
var destroy_on_return: bool = true
var shrink_on_death: bool = true
var spawn_node_when_destroyed: PackedScene

var cull_off_screen: bool = true
var cull_margin: float = 100

var is_multiplayer_sync: bool = true
...
var locked_return_target_position: Vector2 = Vector2.ZERO
var original_forward_direction: Vector2 = Vector2.RIGHT
...
func _apply_resource() -> void:
	...
	has_collision_shape = bullet_resource.has_collision_shape
	collision_shape_size = bullet_resource.collision_shape_size
	collision_shape_offset = bullet_resource.collision_shape_offset
	collision_mask = bullet_resource.collision_mask
	collision_layer = bullet_resource.collision_layer

	bounces_enabled = bullet_resource.bounces_enabled
	max_bounces = bullet_resource.max_bounces
	bounce_damping = bullet_resource.bounce_damping
	bounce_angle_variance = bullet_resource.bounce_angle_variance
	bounce_exception_groups = bullet_resource.bounce_exception_groups
	bounce_only_groups = bullet_resource.bounce_only_groups

	start_speed = bullet_resource.start_speed
	relative_falloff = bullet_resource.relative_falloff
	constant_falloff = bullet_resource.constant_falloff

	boomerang = bullet_resource.boomerang
	boomerang_trigger = bullet_resource.boomerang_trigger
	boomerang_start_at_speed = bullet_resource.boomerang_start_at_speed
	boomerang_start_at_distance = bullet_resource.boomerang_start_at_distance
	boomerang_curve_rate = bullet_resource.boomerang_curve_rate
	boomerang_curve_direction = bullet_resource.boomerang_curve_direction
	dynamic_return_target = bullet_resource.dynamic_return_target
	max_return_distance = bullet_resource.max_return_distance

	follow_target = bullet_resource.follow_target
	steering_degrees = bullet_resource.steering_degrees

	damage = bullet_resource.damage

	destroy_on_no_speed = bullet_resource.destroy_on_no_speed
	destroy_when_colliding = bullet_resource.destroy_when_colliding
	destroy_on_return = bullet_resource.destroy_on_return
	shrink_on_death = bullet_resource.shrink_on_death
	spawn_node_when_destroyed = bullet_resource.spawn_node_when_destroyed

	cull_off_screen = bullet_resource.cull_off_screen
	cull_margin = bullet_resource.cull_margin

	is_multiplayer_sync = bullet_resource.is_multiplayer_sync
...
func destroy() -> void:
	...
	if is_authority and is_multiplayer_sync and multiplayer.has_multiplayer_peer():
		_rpc_destroy.rpc()
